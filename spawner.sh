...
#!/bin/bash
cd /tmp
git clone https://github.com/sirensolutions/gcloud-es-cluster && /bin/bash ./gcloud-es-cluster/constructor.sh CONTROLLER_IP=$MASTER_IP ARTIFACTORY_HOST=$MASTER_IP $CONSTRUCTOR_ARGS |& logger -t es-constructor
EOF
