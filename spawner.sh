...
#!/bin/bash
cd /tmp
git clone https://github.com/sirensolutions/gcloud-es-cluster && /bin/bash ./gcloud-es-cluster/constructor.sh CONTROLLER_IP=$MASTER_IP; export http_proxy=$MASTER_IP:3128; $CONSTRUCTOR_ARGS |& logger -t es-constructor
EOF
